...
function removeButton() {
  let index = taskArray.indexOf(this.parentElement.childNodes[0].nodeValue);
  taskArray.splice(index, 1); // maddeyi silmek için parentElement.remove classını kullandık.
